...
import ru.scadarnull.gomoku.impl.DefaultComputerTurn;
import ru.scadarnull.gomoku.impl.DefaultGameTable;
import ru.scadarnull.gomoku.impl.DefaultHumanTurn;
import ru.scadarnull.gomoku.impl.DefaultWinnerChecker;
...
public class GUIGomoku extends JFrame {
    ...
    protected void markWinnerCells(LinkedList<Cell> winnerCells) {
